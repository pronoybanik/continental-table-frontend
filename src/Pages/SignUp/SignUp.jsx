...
const SignUp = () => {
  ...
  return (
    <section
      ...
      className="bg-white lg:h-[800px] lg:mt-20 shadow-2xl"
    >
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <h1 className="mt-2 uppercase text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">
                please sinUp 🦑
              </h1>
            ...
            >
              ...
              <div className="col-span-12">
                ...
                <input
                  ...
                  name="email"
                  required
                  className="mt-1 w-full pl-2 rounded-md border-gray-200 py-3 border bg-white text-sm text-gray-700 shadow-sm"
                />
              </div>
              ...
              <div className="col-span-12 ">
                ...
                <input
                  ...
                  maxLength="10"
                  minLength="4"
                  className="mt-1 border pl-2 py-3 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                />
              </div>
              ...
              <button
                type="submit"
                className={
                  "inline-block col-span-10 rounded-lg bg-[#D1A054] px-5 py-3 text-sm font-medium text-white  w-full"
                }
              >
                Sign in
              </button>
